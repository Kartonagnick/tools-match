...
#ifdef TEST_TOOLS_STRINGED_STRLEN
...
#include "test-staff.hpp"
    ...
    dMESSAGE("[test][since c++11] tools/stringed/strlen.hpp: enabled -> dHAS_RVALUE_ARRAY")
#else
    dMESSAGE("[test][since c++11] tools/stringed/strlen.hpp: disabled -> dHAS_RVALUE_ARRAY")
#endif
dMESSAGE("[test][since c++11] tools/stringed/strlen.hpp: volatile std::string -> not support")
...
//==============================================================================
#endif // !dHAS_CPP11
#endif // !TEST_TOOLS_STRINGED_STRLEN
